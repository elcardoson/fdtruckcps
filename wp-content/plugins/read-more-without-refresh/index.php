...
function read_main($atts, $content = null) {
	...
	$new_string = '<span><a onclick="read_toggle(' . $rnum . ', \'' . addslashes($more) . '\', \'' . addslashes($less) . '\'); return false;" class="read-link" class="' . addslashes($classTag) . '" id="readlink' . $rnum . '" style="readlink" href="#">' . addslashes($more) . '</a></span>' . "\n";
...
function read_javascript() {
	...
	function read_toggle(id, more, less, classTag) {
		el = document.getElementById("readlink" + id);
		el.innerHTML = (el.innerHTML == more) ? less : more : classTag;
